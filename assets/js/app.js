...
var urlInfo = 'https://demo.soan-solutions.io/test_front/company/CIKLEA/infos';
var urlPayments = 'https://demo.soan-solutions.io/test_front/company/CIKLEA/payments';
var containerPayed = document.querySelector('#payed');
var containerNotPayed = document.querySelector('#not-payed');
var linkPayed = document.querySelector('#payed-link');
var linkNotPayed = document.querySelector('#not-payed-link');
var finalAmount = 0;
var modal = document.getElementById("myModal");
var openModal = document.getElementById("open-modal");
var closeModal = document.getElementById('closed');

function fetchDataJSON() {
  axios__WEBPACK_IMPORTED_MODULE_0___default().get(urlInfo).then(function (response) {
    return response.data;
  }).then(function (info) {
    var name = "<p class=\"m-5 h3 fw-bolder\">".concat(info.company.name, "</p>");
    document.querySelector('#company-name').innerHTML = name;
  });
  axios__WEBPACK_IMPORTED_MODULE_0___default().get(urlPayments).then(function (response) {
    return response.data;
...
function sendDataNotPayed(object) {
  ...
  if (object.discount.isDiscountable == 1) {
    ...
    discountHTML = " <img src=\"assets/images/escompte.svg\" class=\"img-fluid me-1\" alt=\"escompte.svg\">\n                            <p>".concat(object.discount.discountRate, "% d'escompte</p>");
    amountHTML = "<p class=\"text-decoration-line-through\">".concat(object.amount, "\u20AC</p>");
  } else {
  ...
  var newElement = document.createElement('div');
  newElement.classList.add('d-flex', 'payment-row', 'opacity-border-top', 'align-items-center');
  newElement.innerHTML = "\n                <div class=\"checkbox-contain\">\n                    <input  type=\"checkbox\"  class=\"cb\" name=\"objectId\" data-amount=\"".concat(finalAmount, "\" value=\"").concat(object.invoiceNumber, "\" >\n                </div>\n                    <p class=\"col-6 font-bold \">").concat(object.invoiceNumber, "</p>\n                <div class=\"col-5 d-flex justify-content-end\">\n                    <div class=\"d-flex flex-column align-items-end me-3 w-50\">\n                        ").concat(amountHTML, "\n                        <p class=\"font-bold text-primary\">").concat(finalAmount, "\u20AC</p>\n                        <div class=\"d-flex align-items-center justify-content-end escompte-container\">\n                       ").concat(discountHTML, "\n                        </div>\n                    </div>\n                    <div class=\"d-flex\">\n                        <img src=\"assets/images/icon_observateur%20(1).svg\" class=\"me-3 \" alt=\"icon_observateur\">\n                        <img src=\"assets/images/icon_download%20(1).svg\" class=\"me-3 \" alt=\"incon_download\">\n                    </div>\n                </div>");
  containerNotPayed.appendChild(newElement);
}

fetchDataJSON();
linkPayed.addEventListener('click', function (e) {
  e.preventDefault();
...
linkNotPayed.addEventListener('click', function (e) {
  e.preventDefault();
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksoan"] = self["webpackChunksoan"] || [];
